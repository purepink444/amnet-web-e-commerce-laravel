...
@section('title', 'รายละเอียดแบรนด์สินค้า')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">รายละเอียดแบรนด์สินค้า</h3>
                    ...
                    <div class="row">
                                ...
                                @else
                                    <div class="bg-light d-flex align-items-center justify-content-center rounded shadow"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted">ไม่มีโลโก้</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="col-md-8">
                            <table class="table table-borderless">
                                <tr>
                                    <th width="150">ชื่อแบรนด์:</th>
                                    <td>{{ $brand->brand_name }}</td>
                                </tr>
                                <tr>
                                    <th>คำอธิบาย:</th>
                                    <td>{{ $brand->description ?: 'ไม่มีคำอธิบาย' }}</td>
                                </tr>
                                <tr>
                                    <th>สถานะ:</th>
                                    <td>
