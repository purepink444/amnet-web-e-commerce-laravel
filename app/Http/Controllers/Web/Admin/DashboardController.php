...
class DashboardController extends Controller
{
    ...
    /**
     * Get monthly analytics data with optimized PostgreSQL queries
     * Uses proper indexing and raw SQL for maximum performance
     */
    private function getMonthlyAnalytics(): array
    {
        $currentYear = date('Y');

        // Optimized raw SQL for PostgreSQL with proper parameter binding
        ...
        // Fill data from query results (only non-zero months will be updated)
     ...
     * Uses proper indexing and aggregation for performance
     */
    private function getTopSellingProducts(): array
    {
        // Optimized raw SQL with proper PostgreSQL aggregation
        // Uses indexes: idx_order_items_order_product, idx_orders_status_payment
        return \DB::select("
            SELECT
                p.product_name,
